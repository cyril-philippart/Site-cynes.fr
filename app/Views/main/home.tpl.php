    ...
    <div class="card mb-3">
        <div id="intro" class="row no-gutters">
            <div class="col md-6">
                <div class="card-body">
                    <p>CYNES est une agence de communication créative, qui partage les convictions de Monsieur Albert
    ...
    <div id="marg" class="row row row-cols-1 row-cols-md-2 row-cols-xl-4">
        <div id="background-black" class="col mb-4">
            <div class=" overlay-image _b0 ">
                <a href="URL_LIEN">
                    <div class="text">
                        <div class=" text _2 ">Identité visuelle</div>
                    </div>
